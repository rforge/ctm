...
cfun <- function(r, b)  hcl(l = 40 + r^1.5 * 50, c = (1.3 - r^1.5) * 70, h = 260 + b * 100)
...
\begin{center}
  ...
  \end{picture}
\end{center}
\caption{Childhood Nutrition in India. Color-coded map of the $10\%$ and $90\%$
         conditional quantiles of the $Z$ score. The dots in the color legend
         correspond to one district with the respective color in the map.
         ...
         lower but at the same time large upper quantiles. In the southern part
