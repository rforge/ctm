...
<<beetles-model0, echo = TRUE, cache = FALSE>>=
...
\begin{figure}
<<india-risk, echo = FALSE, cache = FALSE>>=
<<insampleriskplot>>
@
\caption{\Sexpr{ds[file]}. In-sample log-likelihood maximisation. \label{\Sexpr{paste0("fig", file, "ib")}}}
\end{figure}
...
\begin{figure}[t]
<<india-pit, echo = FALSE, fig.width = 5, fig.height = 5, cache = FALSE>>=
pitplot(bm, ldata, main = ds[file])
@
\caption{\Sexpr{ds[file]}. Probability-integral transform QQ-plot. \label{\Sexpr{paste0("fig", file, "qq")}}}
\end{figure}
...
\begin{figure}
<<heads-risk, echo = FALSE, cache = FALSE>>=
<<insampleriskplot>>
@
\caption{\Sexpr{ds[file]}. In-sample log-likelihood maximisation. \label{\Sexpr{paste0("fig", file, "ib")}}}
\end{figure}
...
\begin{figure}[t]
<<heads-pit, echo = FALSE, fig.width = 5, fig.height = 5, cache = FALSE>>=
pitplot(bm, ldata, main = ds[file])
@
\caption{\Sexpr{ds[file]}. Probability-integral transform QQ-plot. \label{\Sexpr{paste0("fig", file, "qq")}}}
\end{figure}
...
baselearners:
<<ALSsurv-mlt, cache = FALSE, eval = FALSE>>=
    ...
    for(l2 in lp) {
       for (l3 in lo) {
           ...
           pl <- bwplot(I(boost_ll - true_ll) ~ model |  m + NOBS, data = os, main = main, strip = sc, 
                        ...
                        scales = list(y = list(relation = "free"),
                                      x = list(at = 1:6, label = m[levels(os$model)])))
           plot(pl)
           dev.off()
