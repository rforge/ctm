...
% In future versions \pkg{CVXR}, disciplined
% geometric programming will be added, which will solve this problem.
...
if (file.exists("cache3.rda")) {
  ...
  <<coin_illustration>>
  save(it, file = "cache3.rda")
}
@
<<coin_illustration2, eval=FALSE, echo=FALSE>>=
pvalue(it, "single-step")
@
