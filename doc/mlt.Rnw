...
<<GBSG2-1-mlt>>=
system.time(mlt_GBSG2_1 <- mlt(ctm_GBSG2_1, data = GBSG2, maxit = 3000, scale = TRUE))
@
...
mlt_GBSG2_2 <- mlt(ctm_GBSG2_2, data = GBSG2, fixed = c("log(y)" = 1), scale = TRUE)
@
...
mlt_head <- mlt(ctm_head, data = db, maxit = 5000, 
                scale = TRUE)
@
