...
transformation function $\h$, we slightly rephrase the title
``An Analysis of Transformations'' of the first paper on this subject
\citep{BoxCox_1964} and refer to the methods presented in this
