...
%\VignetteDepends{survival, eha, prodlim, truncreg, lattice, gridExtra, MASS, nnet, HSAUR3, sandwich, flexsurv, grid, latticeExtra, colorspace, multcomp, mgcv, intcox, coxinterval, ICsurv, polspline, logspline, bshazard, gss, MIICD, TransModel, dynsurv, timereg, survivalMPL, np, gamlss, Matrix, muhaz, ICE, ordinal, VGAM}
...
In essense, the package is built around to important functions.  \cmd{ctm}
...
the documentation of \pkg{mlt} will likely also confuse many statisticians,
let alone ``data scientists'' or subject-matter specialists.  Future efforts
