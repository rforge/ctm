...
%\VignetteDepends{tram, survival, MASS, mlbench, multcomp, ordinal}
...
sapply(c("tram", "survival", "MASS", "lattice", "mlbench", "multcomp", "ordinal"), library, char = TRUE)
...
plot(Survreg_GBSG2_1, newdata = nd, which = "distribution", type = "survivor", col = col)
