...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://ctm.r-forge.r-project.org//assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="Research and Software for Transformation Models">
	<meta property="og:url" content="http://ctm.r-forge.r-project.org//assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://ctm.r-forge.r-project.org//software/">Software</a></li>
              <li class="divider"></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="/" title="Transformation Models – ">
